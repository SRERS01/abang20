...
scopeDetails.parameters.forEach(param => {
    try {
        ...
        // Safely sets or overrides the target parameter with your specific exploit payload
        ...
        // Fallback option if input target fails standard URL interface formatting
        testUrls.push({
